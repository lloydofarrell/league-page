/*   STEP 1   */
export const leagueID = "655148069142212608"; // your league ID
export const leagueName = "NFSL Dynasty"; // your league name
...
export const managers = [
    {
      ...
      "name": "Lloyd O'Farrell",
      "tookOver": 2020, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Maynooth", // (optional)
      "bio": "Benevolent Dictator who is way too obsessed with fantasy football than could possibly be healthy.",
      "photo": "/managers/name.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2015, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "nyj", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Schedule Variance", // Can be anything (usually your rival's name)
      ...
      "philosophy": "Every player is gettable if the price is right",
